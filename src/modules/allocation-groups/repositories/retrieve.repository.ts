...
export interface IRetrieveAllocationGroupOutput extends IRetrieveOutput {
  code: string
  name: string
  created_date: string
  updated_date: string
}
export interface IRetrieveAllocationGroupRepository extends IRetrieveRepository {
