...
import { CreateChartOfAccountCategoryUseCase } from '../use-cases/create.use-case'

export const createChartOfAccountCategoryController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
