...
import { DeleteChartOfAccountCategoryRepository } from '../repositories/delete.repository'
import { DeleteChartOfAccountCategoryUseCase } from '../use-cases/delete.use-case'

export const deleteChartOfAccountCategoryController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
