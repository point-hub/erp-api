...
export interface IRetrieveItemCategoryOutput {
  _id: string
  label: string
  code: string
  name: string
...
export interface IRetrieveItemCategoryRepository {
  handle(_id: string): Promise<IRetrieveItemCategoryOutput>
}
...
export class RetrieveItemCategoryRepository implements IRetrieveItemCategoryRepository {
  ...
  async handle(_id: string): Promise<IRetrieveItemCategoryOutput> {
