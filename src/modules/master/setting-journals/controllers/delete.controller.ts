...
import { DeleteSettingJournalRepository } from '../repositories/delete.repository'
import { DeleteSettingJournalUseCase } from '../use-cases/delete.use-case'

export const deleteSettingJournalController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
