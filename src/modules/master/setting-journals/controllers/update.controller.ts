...
import { UpdateSettingJournalUseCase } from '../use-cases/update.use-case'

export const updateSettingJournalController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
