...
export const retrieveAllAllocationController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    // 3.2 retrieve all
    const response = await RetrieveAllAllocationUseCase.handle(
