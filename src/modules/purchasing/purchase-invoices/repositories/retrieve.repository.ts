...
import { IPurchaseOrder, IReference, ISupplier } from '../interface'
...
export interface IRetrievePurchaseInvoiceOutput {
  _id: string
...
export interface IRetrievePurchaseInvoiceRepository {
  handle(_id: string): Promise<IRetrievePurchaseInvoiceOutput>
}

export class RetrievePurchaseInvoiceRepository implements IRetrievePurchaseInvoiceRepository {
  constructor(
    public database: IDatabase,
    public options?: Record<string, unknown>,
  ) {}

  async handle(_id: string): Promise<IRetrievePurchaseInvoiceOutput> {
