...
import { RetrieveDownPaymentUseCase } from '../use-cases/retrieve.use-case'

export const retrieveDownPaymentController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    // 3.2 retrieve
    const response = await RetrieveDownPaymentUseCase.handle(
